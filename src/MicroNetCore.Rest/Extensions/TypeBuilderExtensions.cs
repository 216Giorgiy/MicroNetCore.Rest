...
namespace MicroNetCore.Rest.Extensions
{
    ...
    {
        public static TypeBuilder WithPassThroughConstructors(this TypeBuilder builder, Type baseType)
        {
        ...
        private static IEnumerable<CustomAttributeBuilder> BuildCustomAttributes(
